    ...
    def _handle_PacketIn (self, event):
        ...
        def forward (message = None):
            ...
            if packet.dst.is_multicast:
                ...
                try:
                    id = self.portmap.get((this_dpid, packet.src, packet.dst, packet.find('tcp').dstport))
                    if id == None:
                        raise KeyError
                    else:
                        install_fwdrule(event,packet, self.adjacency[this_dpid][id])
