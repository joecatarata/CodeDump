...
# The input consists of two lines. The first line is the “aaah” Jon Marius is able to say that day. The second line is the “aah” the doctor wants to hear. Only lowercase ’a’ and ’h’ will be used in the input, and each line will contain between
# and

# ’a’s, inclusive, followed by a single ’h’.
# Output

# Output “go” if Jon Marius can go to that doctor, and output “no” otherwise.

moan = [*input("")] # Unpack string
req = [*input("")]

# print(moan)

if moan.count('a') >= req.count('a'):
	print("go")
else:
	print("no")